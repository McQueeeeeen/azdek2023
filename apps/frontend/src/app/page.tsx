          ...
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="group">
                <div className="bg-surface-container-lowest rounded-xl overflow-hidden mb-6 relative aspect-square flex items-center justify-center p-8 transition-transform duration-300 group-hover:scale-[1.02]">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-secondary-container text-on-secondary-container text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded">Ecolabel</span>
                  </div>
                  <img
                    alt="Eco Dish Soap"
                    className="max-w-full max-h-full object-contain mix-blend-multiply"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAsspaP0PkRZ-pTK3yjwYtvXzF74xpeEfUKO5EpKcRmwLtpdjneeInLhP9SSiQbEHuUBzSqCAkcT_prcXWR0gc5fUUNEFdS7KoJtGGPWesRNjfZXdy5LVi-SC29Nt9pBbdrob3siSiLi8MuPV_qP8Q16vMcB_J6dj4bBEEY5NgYpy0kVhlqJoLxHRLL8A4-T7e33CyzQIlH9ucIhM6leugVWM27224EKhwspw1xV0wOji7MaTFd4GBHFvfhlTcYh3Ry_YB2wxe7sNYQ"
                  />
                </div>
                <h3 className="font-bold text-lg mb-1">Гель для посуды "Мята и Лайм"</h3>
                <p className="text-on-surface-variant text-sm mb-4">Гипоаллергенно, 500мл</p>
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-black text-on-surface">380 ₽</span>
                  <button className="bg-surface-container-high p-3 rounded-full hover:bg-primary hover:text-white transition-all">
              ...
              <div className="group">
                <div className="bg-surface-container-lowest rounded-xl overflow-hidden mb-6 relative aspect-square flex items-center justify-center p-8 transition-transform duration-300 group-hover:scale-[1.02]">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-secondary-container text-on-secondary-container text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded">Organic</span>
                  </div>
                  <img
                    alt="Natural Surface Cleaner"
                    className="max-w-full max-h-full object-contain mix-blend-multiply"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBxSaNBip9fDJmkBQgxXw4sPLj_0ONn71kOJKOGYVVHXbpGNAk7YOtfh3ytQDu82QHRDN4V9fg7OM9ilM_JcGsXhIzLbp_ph52mNmK8JVRfk6VulZDPEWRq8hlo5k_a9HGdkFX5cbk0h3M05qEiu_4Dc7aTXVVs76ayJdvTi5WC9eEJuT2reXlqrr8Ld0XySJkTjrQUSjXWeGZMd9miBEY_7i70J5S9SLYtXz5L8t4GPEFW6o_J8TEXXMjAljFiVEQV4WewFVRDKuKY"
                  />
                </div>
                <h3 className="font-bold text-lg mb-1">Спрей для поверхностей</h3>
                <p className="text-on-surface-variant text-sm mb-4">Масло чайного дерева, 450мл</p>
                <div className="flex justify-between items-center">
              ...
              <div className="group">
                <div className="bg-surface-container-lowest rounded-xl overflow-hidden mb-6 relative aspect-square flex items-center justify-center p-8 transition-transform duration-300 group-hover:scale-[1.02]">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-secondary-container text-on-secondary-container text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded">Zero Waste</span>
                  </div>
                  <img
                    alt="Eco Laundry Liquid"
                    className="max-w-full max-h-full object-contain mix-blend-multiply"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAJqDGw4JKcgmif_ctAKr0xYQnwOqKK1rY9sKLC9DPb5jlZ0woWGdmD_s9cCt_KRhM_8_qHOZVG016fDoGFO2B-Oh04S6HYBj8QxdLsZPiU3PLiQMgmGcIz7qDVDnAyEp_lAovRIiIcCgjVye43BaKWDm0ZWALibw1t1oCPXvlpjpjReQBL9HRKLvjxlG-qsjYo_houUElSTGIXfzqm1vH1on-2nLEevBjAMtub_o0vTYBdOPUvDiwn-fshCWj803n-wwoXlO6kcApH"
                  />
                </div>
                <h3 className="font-bold text-lg mb-1">Жидкое средство для стирки</h3>
                <p className="text-on-surface-variant text-sm mb-4">Лаванда и Хлопок, 1000мл</p>
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-black text-on-surface">820 ₽</span>
                  <button className="bg-surface-container-high p-3 rounded-full hover:bg-primary hover:text-white transition-all">
                    <span className="material-symbols-outlined">add_shopping_cart</span>
                  </button>
                </div>
              ...
              <div className="group">
                <div className="bg-surface-container-lowest rounded-xl overflow-hidden mb-6 relative aspect-square flex items-center justify-center p-8 transition-transform duration-300 group-hover:scale-[1.02]">
                  <div className="absolute top-4 left-4 z-10">
                    <span className="bg-secondary-container text-on-secondary-container text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded">100% Bio</span>
                  </div>
                  <img
                    alt="Eco Bathroom Cleaner"
                    className="max-w-full max-h-full object-contain mix-blend-multiply"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDYt5KP5WAWX-e4Sph1Iar_aylbPtjEbpKBStm5FLzJ9ekKWGR_DG5i_TVuPMd098FWtgsyIN5ypljoMgOGN1LBJBY4Ta_7IRwDy8lP_twnpWfKsp3FpxvCuUkBBKAzmOYulV2oW7dsf1YE4vGFJVOjeZog4h8OAcozOuEXhhNYg3AEjHWAoFRafTf-tHwJ5UOOyfaja7pqengkB3-2W7jxwfNvKqhSvBnfD3TBkjVdLGCmh1VFCARrEKgaJ5PE_7z1hGtkQNwfnlz4"
                  />
                </div>
                <h3 className="font-bold text-lg mb-1">Универсальное мыло-концентрат</h3>
                <p className="text-on-surface-variant text-sm mb-4">Хвоя и Эвкалипт, 250г</p>
                <div className="flex justify-between items-center">
                  <span className="text-2xl font-black text-on-surface">590 ₽</span>
                  <button className="bg-surface-container-high p-3 rounded-full hover:bg-primary hover:text-white transition-all">
                    <span className="material-symbols-outlined">add_shopping_cart</span>
                  </button>
                </div>
